...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_488,blur:_48c,mouseenter:_490,mouseleave:_493,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请填写正确的emal地址."},url:{validator:function(_4b3){
...
},message:"请填写正确的URL地址."},length:{validator:function(_4b4,_4b5){
var len=$.trim(_4b4).length;
return len>=_4b5[0]&&len<=_4b5[1];
},message:"输入内容长度必须介于{0}和{1}之间."},remote:{validator:function(_4b6,_4b7){
var data={};
data[_4b7[1]]=_4b6;
var _4b8=$.ajax({url:_4b7[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4b8=="true";
},message:"请修正该字段."}},onBeforeValidate:function(){
