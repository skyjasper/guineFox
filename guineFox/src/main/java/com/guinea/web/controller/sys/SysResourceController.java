...
public class SysResourceController extends BaseFormController {
    ...
    public String printWelcome(ModelMap model) {
        ...
        model.put("ztreeNodes", JSON.toJSONString(treeNodes));
    ...
    public void processAdd(SysResource sysResource, HttpServletRequest request, HttpServletResponse response) {
        if (null != sysResource) {
            ...
            if (StringUtils.isNotBlank(url) && StringUtils.isNotBlank(permission) && StringUtils.isNotBlank(name)) {
                ...
                if (resDB != null) {
                    ...
                    succMesgParam(request, response, sysResource);
                }
            } else {
    ...
    public void processEdit(SysResource sysResource, HttpServletRequest request, HttpServletResponse response) {
        if (null != sysResource) {
    ...
    public void processRoleUserRange(Long roleId, HttpServletRequest request, HttpServletResponse response) {
        showDataGrid(request, response, JSON.toJSONString(sysResourceService.processRoleUser(roleId)));
    }
    ...
    public void processRoleRange(Long roleId, HttpServletRequest request, HttpServletResponse response) {
        showDataGrid(request, response, JSON.toJSONString(sysResourceService.processRoleResource(roleId)));
    }
